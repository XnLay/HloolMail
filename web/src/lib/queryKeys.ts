export const queryKeys = {
  ...
  loginSettingsEmailDelivery: (deliveryId: number | string | null) =>
    ['login-settings', 'email-delivery', deliveryId] as const,
  domains: {
  ...
  admin: {
    ...
    loginSettingsEmailDelivery: (deliveryId: number | string | null) =>
      ['admin-login-settings', 'email-delivery', deliveryId] as const,
    ...
    domainHealth: (page: number, perPage: number, search: string, filters: object) =>
      ['admin-domain-health', page, perPage, search, filters] as const,
    ...
    domainCheckRuns: (page: number, perPage: number) =>
      ['admin-domain-check-runs', page, perPage] as const,
    apiInterfaceSettings: ['admin-api-interface-settings'] as const,
    rateLimitSettings: ['admin-api-rate-limit-settings'] as const,
    auditLogsRoot: ['admin-audit-logs'] as const,
    auditLogs: (filters: object, search: string, page: number, perPage: number) =>
      ['admin-audit-logs', filters, search, page, perPage] as const,
    shareLinksRoot: ['admin-share-links'] as const,
    shareLinks: (page: number, perPage: number, search: string, filters: object) =>
      ['admin-share-links', page, perPage, search, filters] as const,
    shareLinkAccessLogsRoot: (linkId: number) => ['admin-share-link-access-logs', linkId] as const,
    shareLinkAccessLogs: (linkId: number, page: number) =>
      ['admin-share-link-access-logs', linkId, page] as const,
    webhooksRoot: ['admin-webhooks'] as const,
    webhooks: (query: string) => ['admin-webhooks', query] as const,
    webhookDeliveriesRoot: (endpointId: number) =>
      ['admin-webhook-deliveries', endpointId] as const,
    webhookDeliveries: (endpointId: number, page: number) =>
      ['admin-webhook-deliveries', endpointId, page] as const,
  },
  webhooks: {
    ...
    deliveries: (endpointId: number, page: number) =>
      ['webhook-deliveries', endpointId, page] as const,
    ...
    adminDeliveries: (endpointId: number, page: number) =>
      ['admin-webhook-deliveries', endpointId, page] as const,
  },
};
